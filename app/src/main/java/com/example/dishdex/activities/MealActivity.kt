...
import com.example.dishdex.databinding.ActivityMealBinding
...
import com.example.dishdex.viewModel.MealViewModel
import com.example.dishdex.viewModel.MealViewModelFactory
...
class MealActivity : AppCompatActivity() {
    ...
    private fun onFavoriteClick() {
        binding.btnAddToFav.setOnClickListener {
            mealToSave?.let { mealMvvm.insertMeal(it)
